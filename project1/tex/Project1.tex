...
/tree/master/doc/Projects/2021/Project1/DataFiles}}. Our model for both datasets will be a polynomial fit with an $x$ and $y$ dependence of the form $[1,x,y,x^2,y^2,xy,\dots]$.
