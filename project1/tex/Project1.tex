...
We have also plotted the bias and variance for Lasso in figure \ref{fig:Lasso_BVT}. It is very difficult to extrapolate any information from the plot, however we can notice some features.
\begin{figure}[h]
	\includegraphics[width=\linewidth]{LBVT_Lasso_Bootstrap_n30_eps0_2_p20_lmbm5_m2.pdf}
