...
\section{Conclusion}
With SGD we managed to get the exact same $MSE = 0.0471$ as our previous project \cite{project1}. This was done with learning rate $\eta = 0.25$ and with implementation of momentum parameter $\gamma$ and dynamic learning rate $\eta$ separately.

When analyzing the cancer data with logistic regression and neural network, we got an maximum accuracy score of 99.1\%. This corresponds to one miss-classification and is consistent with implementation Scikit-Learn's logistic regression. 
