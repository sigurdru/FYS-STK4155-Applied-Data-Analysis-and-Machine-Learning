...
Lastly, as for the Franke function, we test how different numbers of hidden layers affect the result. Figure \ref{fig:NN_class_layers} shows the results for 4 different structures. All the hidden layers in all the nets have 20 nodes. In the top left1
