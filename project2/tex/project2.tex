...
\section{Conclusion}
With SGD we managed to get the exact same $MSE = 0.071$ as our previous project \cite{project1}. This was done with learning rate $\eta = 0.25$ and with implementation of momentum parameter $\gamma$ and dynamic learning rate $\eta$ separately.
